#!/bin/sh
# DSW ablation dsw-qmix-h: |w| hypernet weights on both mixers; soft monotonicity regulariser off
set -e
cd "$(dirname "$0")"
...
COMMON="python3 main.py --rl-model rnn --mixer multi-qmix --policy-disc --application ${APP} \
...
echo "========== dsw-qmix-h (hard |w| mono, no soft mono) =========="
${COMMON} --log-dir "${BASE_LOG}_dsw_qmix_h" --hard-mixer-mono --disable-soft-mono
